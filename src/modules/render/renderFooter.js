...
const copyright = createElement('div',
  {
    ...
    innerHTML: `
      <p class="footer__text footer-copyright__text">© INSPIRED, 2023</p>
    `
  },
);

const development = createElement('div',
  {
    className: 'footer__item footer__item_development footer-development',
    innerHTML: `
      <ul class="footer-development__list">
        <li class="footer-development__item footer-development__text footer__text">
          Designer: <a class="footer__link" href="https://t.me/Mrshmallowww" target="_blank">Anastasia Ilina</a>
        </li>
        <li class="footer-development__item footer-development__text footer__text">
          Developer: <a class="footer__link" href="https://t.me/irinkwink" target="_blank">Irina Nazarova</a>
        </li>
      </ul>
    `
  },
...
const container = createElement('div',
  ...
  },
  {
    child: createElement('div',
      ...
      {
        children: [category, social, contacts, copyright, development]
      }
    )
  }
)
